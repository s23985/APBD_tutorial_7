...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        /// <summary>
        ///     SELECT Job AS Praca, COUNT(1) LiczbaPracownikow FROM Emps     // should return IEnumerable<object> not <Dept>, I think
        ///     WHERE Job LIKE '%A%'
        ///     GROUP BY Job
        ///     HAVING COUNT(*)>2
        ///     ORDER BY COUNT(*) DESC;
        ...
        public static IEnumerable<object> Task16()
        {
            ...
            IEnumerable<object> result = all.ToList(); 
